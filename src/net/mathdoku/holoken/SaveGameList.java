...
public class SaveGameList extends ListActivity {
	...
	public static final String SAVEGAME_PREFIX = SAVEGAME_DIR + "savegame_";
	...
	public void deleteGameDialog(final String filename) {
		new AlertDialog.Builder(SaveGameList.this)
        ...
        .setPositiveButton(R.string.dialog_ok, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int whichButton) {
            		SaveGameList.this.deleteSaveGame(filename);
                }
        })
        .show();
	}
	...
	public void createSaveGame() {
		...
		for (fileIndex = 0 ; ; fileIndex++)
			if (! new File(SAVEGAME_PREFIX + fileIndex).exists())
				break;
		String filename = SAVEGAME_PREFIX + fileIndex;
		try {
